...
?>
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li><a class="active" href="a_returned.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Returned Items</h1>
			</div>
		</div><!--/.row-->
		...
		<div style="max-width: 800px; margin: 0 auto; padding: 20px;">
			<table style="width: 100%; border-collapse: collapse;">
				<tr>
					...
					<th style="background-color: #c6c4fc; color: black; border: 1px solid #ddd; padding: 8px; text-align: left;">Returned Item</th>
					<th style="background-color: #c6c4fc; color: black; border: 1px solid #ddd; padding: 8px; text-align: left;">Borrowed Date</th>
					<th style="background-color: #c6c4fc; color: black; border: 1px solid #ddd; padding: 8px; text-align: left;">Returned Date</th>
				...
				<tr>
					...
					<td style="border: 1px solid #ddd; padding: 8px; text-align: left;">15/5/23</td>
				...
				<tr>
					<td style="border: 1px solid #ddd; padding: 8px; text-align: left;">Amy Rofar</td>
					<td style="border: 1px solid #ddd; padding: 8px; text-align: left;">Extension</td>
					<td style="border: 1px solid #ddd; padding: 8px; text-align: left;">28/6/23 9:00</td>
					<td style="border: 1px solid #ddd; padding: 8px; text-align: left;">28/6/23 16:00</td>
					<td style="border: 1px solid #ddd; padding: 8px; text-align: center;">
                        <button style="background-color: #007BFF; color: white; border: none; border-radius: 5px; padding: 5px 10px; cursor: pointer;">Info</button>
                    </td>
				</tr>
